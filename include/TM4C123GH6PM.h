...
#ifndef __TM4C123GH6PM_H_TEST__
#define __TM4C123GH6PM_H_TEST__
...
typedef struct {                                    /*!< WATCHDOG0 Structure                                                   */
  ...
  __IO uint32_t  WATCHDOGTEST;                              /*!< Watchdog Test                                                         */
...
typedef struct {                                    /*!< USB0 Structure                                                        */
  ...
  __IO uint8_t   USB0TEST;                              /*!< USB Test Mode                                                         */
  __I  uint32_t  RESERVED[4];
